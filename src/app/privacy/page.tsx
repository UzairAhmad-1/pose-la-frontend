            ...
            <section className="rounded-lg p-6 bg-gray-50">
              ...
              <div className="space-y-3">
                <p className="leading-relaxed">
                  ...
                  personnelles effectuées par l&apos;intermédiaire de
                  l&apos;application POSE-LÀ.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="p-3 mt-2 rounded bg-white">
                    <p className="text-gray-700 text-sm">
                      ...
                      paiement certifiés. La Société n&apos;accède jamais
                      directement à ces informations sensibles.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    tablette, ordinateur), système d&apos;exploitation, version
                    de l&apos;application, adresse IP (soumise à
                    pseudonymisation à des fins de sécurité), identifiants
                    techniques (cookies ou technologies équivalentes).
                  </p>
                </div>
                ...
                <div className="p-4 rounded bg-white">
                  ...
                  <p className="text-gray-700">
                    L&apos;application POSE-LÀ s&apos;interdit de conserver le
                    contenu des échanges conversationnels. L&apos;ensemble des
                    communications bénéficie d&apos;un chiffrement de bout en
                    bout garantissant leur confidentialité absolue.
                  </p>
                </div>
                ...
                <div className="p-4 rounded bg-white">
                  ...
                  <p className="text-gray-700 text-sm">
                    ...
                    contourner la période d&apos;essai gratuite,
                    l&apos;application peut enregistrer temporairement des
                    marqueurs techniques minimisés (par exemple : empreinte
                    d&apos;appareil, adresse e-mail hachée ou adresse IP
                    partiellement masquée).
                  </p>
                  <p className="text-gray-700 text-sm mt-2">
                    Ces informations servent uniquement à la détection
                    d&apos;abus et ne permettent pas d&apos;identifier
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded bg-white">
                  ...
                  <p className="text-gray-700 text-sm">
                    ...
                    l&apos;objet d&apos;analyses à des fins de sécurité
                    (détection d&apos;abus et de contenus inappropriés).
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded bg-white">
                  <p className="text-gray-700 font-semibold">
                    La Société s&apos;engage formellement à ne jamais procéder à
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                    <li>
                      ...
                      d&apos;hébergement, processeurs de paiement, outils
                      d&apos;analyse) liés par des contrats conformes au RGPD
                    </li>
                    <li>
            ...
            <section className="rounded-lg p-6 bg-gray-50">
              ...
              <div className="space-y-4">
                <p className="leading-relaxed">
                  ...
                  sein de l&apos;Union européenne. Dans l&apos;hypothèse
                  exceptionnelle d&apos;un transfert vers un pays situé hors de
                  l&apos;Espace Économique Européen (EEE), nous mettons en œuvre
                  les garanties appropriées :
                </p>

                <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                  <li>
                    Décisions d&apos;adéquation adoptées par la Commission
                    européenne
                  </li>
                  <li>
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded bg-white">
                    ...
                    <p className="text-gray-700 text-sm">
                      Obtenir la suppression de vos données (« droit à
                      l&apos;oubli »)
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded bg-white">
                  ...
                  <p className="text-gray-700 text-sm">
                    En cas de litige, vous pouvez saisir l&apos;autorité de
                    contrôle de votre pays. En France : CNIL
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-lg p-6 bg-gray-50">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    Les contenus générés par l&apos;IA sont un accompagnement,
                    pas un avis médical, psychologique ou juridique.
                  </p>
                </div>
                <div className="flex items-start">
                  <span className="text-black mr-2">•</span>
